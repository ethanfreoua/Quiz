...
function showResults(results) {
  const errorsNumber = results.filter((elem) => elem === false).length;
  ...
  switch (errorsNumber) {
    case 0:
      ...
      Score : <span>${errorsNumber} / 5</span>`;
    ...
    case 1:
      ...
      helpResult.style.display = "block";
      markResult.innerHTML = `Score : <span>${errorsNumber} / 5</span>`;
      markResult.style.display = "block";
      break;
    case 2:
...
function resetColor(e) {
  ...
  questions[index].style.backgroundImage = "none";
}
